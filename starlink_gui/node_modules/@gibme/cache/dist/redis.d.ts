...
export { Cache };
export declare class Redis extends Cache {
    private readonly options;
    readonly client: import("@redis/client").RedisClientType<{
        json: {
            ARRAPPEND: {
     ...
     * @param options
     */
    constructor(options?: Partial<Redis.Config>);
...
export declare namespace Redis {
    type Config = RedisClientOptions & {
        host: string;
        port: number;
        stdTTL: number;
    };
